...
using System.Text;
using System.IO;
using MHXSaveEditorOSX.Data;

namespace MHXSaveEditorOSX.Util
{
    public class DataExtractor
    {
        ...
        public SaveFile GetSaveFile()
        {
            ...
            for (int index = 0; index < 3; index++)
            {
                ...
                player.TalismanList = new Talisman[Constants.TOTAL_ITEM_BOX_SLOTS];
                for (int equipmentIndex = 0; equipmentIndex < Constants.TOTAL_ITEM_BOX_SLOTS; equipmentIndex++)
                {
                    ...
                    // separating charms from everything else
                    if (player.EquipmentBox[equipmentIndex].TypeID == 6)
                    {
                        player.TalismanList[equipmentIndex] = new Talisman(player.EquipmentBox[equipmentIndex], equipmentIndex);
                    }
                }
